...
const Salary = ({handleChange , handleClick}) => {
  return (
    <div>
        ...
        <div className='mb-4'>
           <Button onClickHandler={handleClick} value ="" title = "hour"/>
           <Button onClickHandler={handleClick} value ="monthly" title = "month"/>
           <Button onClickHandler={handleClick} value ="Yearly" title = "year"/>
        </div>
        <div>
